    ...
    <main className="bg-sand h-full w-screen bg-fixed">
      ...
      <section className="lg:flex lg:justify-between lg:pt-20 lg:px-32  px-10 pt-10">
        <div className=" flex flex-col items-center lg:items-start my-20 lg:my-20  lg:mx-20 gap-20">
          <Reveal>
            <div className="text-5xl lg:text-8xl text-blak font-mirage">
              <h1>ABout</h1>
            </div>
          </Reveal>
          <Reveal>
            <div className="w-[250] lg:w-[550px] text-xl lg:text-2xl text-blak font-mirage">
              <p>
          ...
          <div className="font-serif flex flex-col w-[250] lg:w-[500px] text-base lg:text-lg text-blak gap-10">
            <Reveal>
              <p>
          ...
          <Reveal>
            <div className="font-serif flex flex-col w-[250] lg:w-[500px] text-base lg:text-lg text-blak gap-10">
              ...
              <div className="font-mirage text-xl lg:text-2xl text-blak">
                <p>
              ...
              <div>
                <p>
                  This quote deeply resonates with me because it reflects my
                  genuine desire to create things that truly matter and make a
                  positive impact in the world. My passion lies in crafting,
                  designing, and building ideas and products that hold
                  significance and bring about positive change.
                </p>
              </div>
            </div>
          </Reveal>
      ...
      <section className="flex flex-col pt-10 lg:mx-32 lg:pb-20 pb-10">
        <div className=" flex flex-col items-center lg:items-start font-mirage text-5xl lg:text-8xl text-blak lg:px-20 gap-10 mx-4 lg:mx-0">
          <Reveal>
            <h1>SKills</h1>
          </Reveal>
          <Reveal>
            <div className="flex flex-col items-center lg:items-start gap-4 text-2xl lg:text-4xl lg:pt-10">
              <h2>Frontend</h2>
